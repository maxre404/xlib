...
class AlbumDraggableAdapter(private val items: MutableList<String>) :
    RecyclerView.Adapter<AlbumDraggableAdapter.MyViewHolder>(), ItemMoveAdapter {

    // ... ViewHolder 和其他 Adapter 方法保持不变 ...
    
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_drag_photo_album, parent, false)
